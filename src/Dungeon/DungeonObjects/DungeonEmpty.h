 ...
 *
 */
#ifndef __HEADER_DUNGEON_EMPTY_
#define __HEADER_DUNGEON_EMPTY_
 ...
 *
 */
class DungeonEmpty : public DungeonBase
{
public:
   DungeonEmpty();
   virtual ~DungeonEmpty() override;
