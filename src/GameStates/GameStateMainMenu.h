 ...
 *
 */
#ifndef __HEADER_GAME_STATE_MAIN_MENU_
#define __HEADER_GAME_STATE_MAIN_MENU_

/**
 *
 */
class GameModeMainMenu : public GameModeBase
{
public:

   GameModeMainMenu();
   virtual ~GameModeMainMenu() override;

   virtual void enterGameMode() override;
   virtual void leaveGameMode() override;
   
   explicit GameModeMainMenu(GameModeMainMenu *inGameModeMainMenu);
   GameModeMainMenu &operator=(const GameModeMainMenu &GameModeMainMenu);
...
#endif /*__HEADER_GAME_STATE_MAIN_MENU_*/
