 ...
 *
 */
#ifndef __HEADER_MINI_MAP_
#define __HEADER_MINI_MAP_
...
public:
   ...
   void setMiniMapVisible(bool inVisible = true);

   void switchMiniMapVisible();

protected:

   int m_MiniMapVisible;
};

#endif /*__HEADER_MINI_MAP_*/
